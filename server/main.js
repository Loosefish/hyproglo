...
var _user$project$Model$Model = F2(
	function (a, b) {
		return {perspective: a, artists: b};
	});
var _user$project$Model$Artist = function (a) {
	return {name: a};
};
var _user$project$Model$NoOp = {ctor: 'NoOp'};
var _user$project$Model$ChangePerspective = function (a) {
	return {ctor: 'ChangePerspective', _0: a};
};
var _user$project$Model$GotAlbumArtists = function (a) {
	return {ctor: 'GotAlbumArtists', _0: a};
};
var _user$project$Model$Fetch = function (a) {
	return {ctor: 'Fetch', _0: a};
};
var _user$project$Model$Playlist = {ctor: 'Playlist'};
var _user$project$Model$Music = function (a) {
	return {ctor: 'Music', _0: a};
};
var _user$project$Model$default = A2(
	_user$project$Model$Model,
	_user$project$Model$Music(_elm_lang$core$Maybe$Nothing),
	_elm_lang$core$Native_List.fromArray(
		[]));

var _user$project$Mpd$group = function () {
	var group$ = function (pairs) {
		var _p0 = pairs;
		if ((_p0.ctor === '::') && (_p0._0.ctor === '_Tuple2')) {
			...
			return A2(
				...
				A2(
					_elm_lang$core$List_ops['::'],
					{ctor: '_Tuple2', _0: _p4, _1: _p0._0._1},
					here),
				group$(rest));
		} else {
			return _elm_lang$core$Native_List.fromArray(
...
var _user$project$Mpd$parseMpd = function (raw) {
	var toTuple = function (xs) {
		var _p6 = xs;
	...
	return A2(_elm_lang$core$String$endsWith, 'OK\n', raw) ? A2(
		...
		A2(
			...
			_elm_community$list_extra$List_Extra$init(
				_elm_lang$core$String$lines(raw)))) : _elm_lang$core$Native_List.fromArray(
		[]);
};
var _user$project$Mpd$toArtist = function (pairs) {
	return A2(
		_elm_lang$core$Maybe$map,
		_user$project$Model$Artist,
		_elm_lang$core$Maybe$oneOf(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Dict$get, 'AlbumArtist', pairs),
					A2(_elm_lang$core$Dict$get, 'Artist', pairs)
				])));
};
var _user$project$Mpd$parseArtists = function (_p8) {
	return _user$project$Model$GotAlbumArtists(
		_elm_lang$core$Result$Ok(
			A2(
				_elm_lang$core$List$filterMap,
				_user$project$Mpd$toArtist,
				_user$project$Mpd$group(
					_user$project$Mpd$parseMpd(_p8)))));
};
var _user$project$Mpd$MpdAnswer = F3(
	function (a, b, c) {
		return {status: a, error: b, result: c};
	});
var _user$project$Mpd$mpdDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Mpd$MpdAnswer,
...
var _user$project$Mpd$sendMpd = function (query) {
	var fail = function (_p9) {
		return _elm_lang$core$Task$fail(
			_evancz$elm_http$Http$UnexpectedPayload(_p9));
	};
	var validate = function (mpd) {
		var _p10 = {ctor: '_Tuple3', _0: mpd.error, _1: mpd.status, _2: mpd.result};
		if (_p10._0.ctor === 'Just') {
			return fail(_p10._0._0);
		} else {
			if (_p10._1.ctor === 'Nothing') {
				return fail('empty status');
			} else {
				if (_p10._2.ctor === 'Nothing') {
					return fail('empty result');
				} else {
					var _p11 = _p10._1._0;
					return A2(_elm_lang$core$String$startsWith, 'OK MPD', _p11) ? _elm_lang$core$Task$succeed(_p10._2._0) : fail(_p11);
				}
			}
		}
	};
	var post = A3(
		...
		_user$project$Mpd$mpdDecoder,
		'/cgi-bin/mpd',
		_evancz$elm_http$Http$string(query));
	return A2(_elm_lang$core$Task$andThen, post, validate);
};
var _user$project$Mpd$getAlbumArtists = A3(
	_elm_lang$core$Task$perform,
	function (_p12) {
		return _user$project$Model$GotAlbumArtists(
			_elm_lang$core$Result$Err(_p12));
	},
	_user$project$Mpd$parseArtists,
	_user$project$Mpd$sendMpd('list AlbumArtist'));

var _user$project$View$groupBy = function (key) {
	var append = F2(
		function (y, ys) {
			return _elm_lang$core$Maybe$Just(
				A2(
	...
	return function (_p2) {
		return A2(
			...
			F2(
				function (_p3, l) {
					return _elm_lang$core$List$sort(l);
				}),
			A2(groupBy$, _elm_lang$core$Dict$empty, _p2));
	};
};
var _user$project$View$viewAlbumArtists = function (model) {
	var artistPill = function (name) {
		var action = _elm_lang$html$Html_Events$onClick(
			_user$project$Model$ChangePerspective(
				_user$project$Model$Music(
					_elm_lang$core$Maybe$Just(
						_user$project$Model$Artist(name)))));
		var link = _elm_lang$html$Html_Attributes$href(
			A2(_elm_lang$core$Basics_ops['++'], '#/music/', name));
		return A2(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$core$List$map, artistPill, _p5._1))
				]));
	};
	var grouped = A2(
		_user$project$View$groupBy,
		function (_p6) {
			return _elm_lang$core$String$toUpper(
				A2(_elm_lang$core$String$left, 1, _p6));
		},
		A2(
			_elm_lang$core$List$map,
			function (_) {
	...
	var header = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Album Artists')
			]));
	return A2(
		_elm_lang$core$List_ops['::'],
		header,
...
var _user$project$View$filterMaybe = _elm_lang$core$List$filterMap(
	function (x) {
		return x;
	});
var _user$project$View$btn = function (content) {
	return A2(
		_elm_lang$html$Html$a,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$View$fa = function (icon) {
	return A2(
		_elm_lang$html$Html$span,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$View$btnFa = function (_p7) {
	return _user$project$View$btn(
		_user$project$View$fa(_p7));
};
var _user$project$View$view = function (model) {
	var status = _elm_lang$core$Maybe$Just(
		A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('0:16 / 5:07')
								]))
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('img-responsive hidden-xs center-block'),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Computerwelt')
								])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Kraftwerk')
								])),
							A2(
							_elm_lang$html$Html$h6,
							_elm_lang$core$Native_List.fromArray(
	...
	var controls = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('btn-group btn-group-sm btn-group-justified')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$btnFa('play')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$btnFa('fast-backward'),
						_user$project$View$btnFa('stop'),
						_user$project$View$btnFa('fast-forward')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$btnFa('random'),
						_user$project$View$btnFa('repeat'),
						_user$project$View$btn(
						_elm_lang$html$Html$text('1'))
					]))
			]));
	var active = function (p) {
		return _elm_lang$core$Native_Utils.eq(p, model.perspective) ? _elm_lang$core$Native_List.fromArray(
			[
	...
	var navs = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('nav nav-sidebar')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('#/music'),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$View$fa('database'),
								_elm_lang$html$Html$text(' Music ')
							]))
					])),
				A2(
				_elm_lang$html$Html$li,
				active(_user$project$Model$Playlist),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_lang$html$Html$a,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('#/playlist'),
								_elm_lang$html$Html_Events$onClick(
								_user$project$Model$ChangePerspective(_user$project$Model$Playlist))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$View$fa('list'),
								_elm_lang$html$Html$text(' Playlist '),
								A2(
								_elm_lang$html$Html$span,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('badge pull-right')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
	...
	var main = function () {
		var _p8 = model.perspective;
		if (_p8.ctor === 'Music') {
			if (_p8._0.ctor === 'Nothing') {
				return _user$project$View$viewAlbumArtists(model);
			} else {
				return _elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(_p8._0._0.name)
							]))
					]);
			}
		} else {
	...
	var sidebar = _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$html$Html$h4,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('HyProGlo')
				])),
			navs,
			A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_user$project$View$filterMaybe(
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$core$Maybe$Just(controls),
						status
					])))
		]);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-xs-12 col-sm-3 col-md-2 sidebar')
					]),
				sidebar),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('col-xs-12 col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main')
					]),
				main)
			]));
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'Fetch':
				return {ctor: '_Tuple2', _0: model, _1: _p2._0};
			case 'GotAlbumArtists':
				if (_p2._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
					...
					return {
						...
						_1: A2(
							...
							_user$project$Model$Fetch(_user$project$Mpd$getAlbumArtists))
					};
				}
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Model$default, _1: _user$project$Mpd$getAlbumArtists},
